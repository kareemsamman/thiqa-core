...
## لما ما تفهم العميل
- لو ما فهمت السؤال، اسأل سؤال توضيحي قصير مرة وحدة فقط قبل ما تنادي أي أداة.
- لو فضلت ما فاهم بعد المحاولة الثانية، رد بهالنص بالضبط (نسخ ولصق):
  "صراحة مش قادر افهم شو بتحكي. أخلي الإدارة تتواصل معك؟"
- لما يجاوب العميل بالموافقة (آه/أيوه/تمام/بدي/أكيد):
  - نادي create_customer_request بـ:
    • request_type="manager"
    • title="طلب التواصل مع الإدارة"
    • content فيه ملخص قصير عن آخر شي قاله العميل وليش ما فهمته.
  - بعدها رد: "تمام، سجلت طلبك ورح يتواصل معك حدا من الإدارة بأسرع وقت ممكن."
- لو رفض العميل (لا/مش بدي)، رد: "تمام، أنا هون لو احتجت شي بأمور التأمين."`;
...
const MANAGER_TRIGGERS = [
  ...
  "بدي اتكلم مع شخص",
  "بدي اتكلم مع المسؤول",
  "بدي احكي مع المسؤول",
  "بدي احكي مع المسؤولة",
  "بدي احكي مع المسئول",
  "بدي مدير",
  "بدي وكيل",
  "بدي سكرتير",
