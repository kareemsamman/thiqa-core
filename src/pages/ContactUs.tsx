...
import { ContactPageJsonLd } from "@/components/public/PublicJsonLd";
  ...
  return (
    ...
    >
      <PublicSEO
        ...
        description="تواصل مع فريق Thiqa للحصول على عرض توضيحي مجاني، الدعم الفني، أو الاستفسار عن خطط وكالات التأمين. نرد خلال ساعات العمل."
