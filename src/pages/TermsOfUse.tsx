      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-20 space-y-14">
        ...
        <Section icon={<CreditCard className="h-5 w-5" />} number="03" title="الخطط والفترة التجريبية">
          <ul>
            ...
            <li>بعد التجربة، تختار بين خطّتي <strong>Basic</strong> أو <strong>Pro</strong> حسب حجم وكالتك واحتياجاتها.</li>
            <li>التغيير بين الخطّتين متاح في أي وقت من إعدادات الاشتراك. فروقات السعر تُحتسب بالتناسب.</li>
