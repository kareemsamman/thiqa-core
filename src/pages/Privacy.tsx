      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-20 space-y-14">
        ...
        >
          ...
          <ul>
            ...
            <li><strong>بيانات وكالتك:</strong> سجلات العملاء (اسم، هوية، تواصل)، المعاملات التأمينية، المركبات، المدفوعات، الشيكات، العمولات، الموظفون والصلاحيات.</li>
        ...
        >
          <ul>
            ...
            <li>
              ...
              تعديل بيانات عميل، حذف معاملة) في سجل قابل للمراجعة من قبل مدير
              الوكالة.
            </li>
          </ul>
        </Section>
        ...
        >
          <ul>
            ...
            <li>
              <strong>حق التصدير:</strong> صدّر جميع بياناتك (عملاء، معاملات،
