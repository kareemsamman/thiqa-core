...
const featureTiles = [
  {
    ...
    desc: "ملفات عملاء كاملة، سائقون إضافيون، مركبات وتاريخ المعاملات.",
    tint: "bg-indigo-50 text-indigo-600",
    hoverTint: "group-hover:bg-indigo-100",
    gradient: "linear-gradient(135deg, #eef2ff 0%, #c7d2fe 100%)",
    accent: "#4f46e5",
    intro: "ملف عميل موحّد يجمع كل شيء: الهوية، المركبات، السائقين الإضافيين، تاريخ المعاملات والمطالبات — بدون التنقّل بين ملفات Excel.",
    bullets: [
      "ملف عميل مفصّل: الهوية، رقم الملف والملاحظات الطبية",
      "إدارة السائقين الإضافيين وسائقي الأعمار تحت 24",
      "سجل كامل للمركبات والمعاملات والتجديدات",
      "تسجيل الحوادث والمطالبات المرتبطة بكل عميل",
      "بحث متقدم وتصفية حسب الفرع والحالة والوسيط",
    ],
    decorBadges: ["ملف طبي", "سائق إضافي", "تاريخ المعاملات"],
  },
  {
    icon: FileText,
    title: "معاملات، باقات وتجديدات",
    ...
    accent: "#0284c7",
    intro: "معالج إصدار معاملة يدمج الإلزامي + الشامل + خدمات الطريق في باقة واحدة، مع حساب سعر تلقائي حسب قواعد كل شركة تأمين.",
    bullets: [
      "إصدار إلزامي + ثالث/شامل في باقة واحدة",
      "حساب السعر تلقائياً حسب قواعد كل شركة تأمين",
      "خدمات الطريق والحوادث مدمجة بالباقة",
      "تجديدات ذكية مع سجل كامل لكل معاملة",
  ...
  },
  {
    ...
    accent: "#d97706",
    intro: "محفظة مالية لكل وسيط تحسب العمولات تلقائياً على كل معاملة، وتدير التسويات مع الوسطاء وشركات التأمين من لوحة واحدة.",
    bullets: [
      "حساب العمولات تلقائياً على كل معاملة",
  ...
  },
  {
    ...
    desc: "تذكير قبل انتهاء المعاملة، وحملات تسويقية جماعية بضغطة زر.",
    ...
    bullets: [
      "تذكيرات قبل انتهاء المعاملة (شهر وأسبوع)",
...
const featureTabs = [
  {
    ...
    label: "إصدار وتسعير",
    num: "01",
    title: "إصدار معاملات التأمين\nبضغطة واحدة.",
    desc: "معالج ذكي يقودك خطوة بخطوة: اختيار العميل والمركبة، حساب أسعار الإلزامي والثالث والشامل تلقائياً حسب قواعد كل شركة تأمين، وإضافة خدمات الطريق والحوادث في نفس الباقة. المعاملة جاهزة للتوقيع الرقمي بعد دقائق.",
    ...
    image: "https://thiqacrm.b-cdn.net/image%20228.png",
    stats: [
      { value: "3", unit: "دقائق", label: "متوسط الوقت لإصدار معاملة جديدة — من اختيار العميل إلى الإرسال للتوقيع." },
  ...
  },
  {
    ...
    desc: "تذكيرات تجديد تلقائية قبل شهر وأسبوع من انتهاء المعاملة، حملات SMS جماعية مع اختيار عملاء ذكي حسب الفرع أو الشركة، نماذج رسائل مخصصة لكل نوع تنبيه، وتتبع كامل لحالة الإرسال مع تقارير DLR.",
    ...
    stats: [
      { value: "40%", unit: "", label: "ارتفاع في نسبة تجديد المعاملات بفضل التذكيرات التلقائية قبل الانتهاء." },
  ...
  },
  {
    ...
    image: "https://thiqacrm.b-cdn.net/Group%201000011518.png",
    stats: [
  ...
  },
  {
    ...
    desc: "حساب العمولات تلقائياً على كل معاملة، تسويات مع الوسطاء مع تتبع الأرصدة والمستحقات، تسويات مع شركات التأمين بأسعارهم ومدفوعاتهم، وتقارير مفصلة لكل علاقة مالية — بدون جداول إكسل يدوية.",
    ...
    image: "https://thiqacrm.b-cdn.net/image%20231%20(1).png",
    stats: [
...
export default function Landing() {
  ...
  // logged-in or not. Fully-set-up agents can browse here freely (so
  // they can share pricing copy with clients).
  //
    ...
    <div className="min-h-screen text-black overflow-x-hidden bg-white public-page-enter" dir="rtl" style={{ fontFamily: "'Cairo', sans-serif" }}>
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-10 text-[14px] font-medium text-black/75">
            ...
            {/* مركز المعلومات — scroll-to-section dropdown with a
                featured gradient card on the left (end of RTL row). */}
            <div className="relative group">
              ...
              <div className="absolute top-full right-1/2 translate-x-1/2 pt-4 invisible opacity-0 translate-y-1 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200">
                ...
                >
                  ...
                  {/* Featured gradient card (left in RTL — end of the
                      row). Blue→purple gradient matches the landing
                      page's slider gradients. A blurred highlight
                      spot plus the Thiqa wordmark centered on top. */}
                  <a
                    href="/register"
      ...
      <section className="relative md:min-h-screen flex flex-col items-center justify-between overflow-hidden">
        ...
        <div className="relative z-10 w-[94%] max-w-[56rem] mx-auto text-center pt-40 md:pt-44">
          ...
          >
            {ct(content, "hero_subtitle", "إدارة المعاملات، الأموال والتسويق في مكان واحد — سريع وآمن.")}
          </p>
      ...
      >
        ...
        `}</style>
        <div
          className="updates-marquee-viewport px-6 pb-3"
          dir="ltr"
        ...
        >
          <div className="updates-marquee-track">
            {[...featureUpdates, ...featureUpdates].map((u, i) => (
              <div
                key={i}
                className="w-[78vw] max-w-[300px] flex-shrink-0 md:w-[320px]"
              >
                ...
                {[
                  {
                    ...
                    body:
                      "لوحة تحكم واحدة تجمع كل عمليات الوكالة: معاملات، تحصيل، شيكات، عملاء وتقارير — ترى كل شيء بلحظتها وتتخذ قرارات مبنية على أرقام حقيقية.",
                  },
                  {
            ...
            {[
              {
                ...
                bullets: [
                  "أرباح محسوبة حياً على كل معاملة وكل عميل",
              ...
              },
              {
                ...
                intro:
                  "من إصدار المعاملة حتى تجديدها — كل خطوة رقمية، وكل مستند آمن في السحابة.",
                bullets: [
                  "توقيع رقمي عبر SMS يصل الجوال مباشرة",
                  "إدارة مستندات كاملة مع وصول فوري 24/7",
                  "متابعة دورة المعاملة من الإصدار للتجديد",
                ],
                gradient: "linear-gradient(135deg, #eef2ff 0%, #c7d2fe 100%)",
                accent: "#4f46e5",
              },
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 mt-10">
          <p className="gl-fade gl-fade-desc text-[14px] md:text-[15px] text-black/60 max-w-xl mx-auto mb-8 leading-relaxed whitespace-pre-line">
            {ct(content, "grid_desc", "إرسال معاملات للتوقيع الرقمي عبر SMS، إدارة مستندات آمنة في السحابة\nومتابعة كاملة لدورة حياة المعاملة — كل شيء من الكمبيوتر أو الجوال.")}
          </p>
          <Link
            to="/register"
              ...
              >
                <div className="p-8 md:p-10 border-b md:border-b-0 md:border-l border-black/[0.08] flex flex-col justify-center gap-8 order-2 md:order-1 bg-black/[0.02]">
                  <div>
                    ...
                    <p className="text-sm text-black/60 mt-2 leading-relaxed">{ct(content, "testimonials_stat_1_desc", "إرسال معاملات للتوقيع الرقمي عبر SMS، إدارة مستندات آمنة في السحابة ومتابعة كاملة")}</p>
                  </div>
                  <div>
                    <div className="text-5xl md:text-6xl font-extrabold text-black ltr-nums">{ct(content, "testimonials_stat_2", "50%")}</div>
                    <p className="text-sm text-black/60 mt-2 leading-relaxed">{ct(content, "testimonials_stat_2_desc", "إرسال معاملات للتوقيع الرقمي عبر SMS، إدارة مستندات آمنة في السحابة ومتابعة كاملة")}</p>
                  </div>
                </div>
      ...
      {/* ═══ FAQ ═══ Shared component used on /landing#faq AND on the
          pricing page, so wording stays in lock-step everywhere. */}
      <FAQSection />
