      ...
      <DialogContent dir="rtl" className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-right pt-1">
            اختر الكمية التي تريد إضافتها لهذا الشهر. المبلغ سيُضاف إلى فاتورتك الشهرية وسيكون الرصيد متاحاً للاستخدام فوراً.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="flex items-start gap-2 text-[11px] text-muted-foreground">
            ...
            <p>
              المبلغ سيُضاف إلى فاتورتك الشهرية القادمة. الرصيد مفعّل فوراً ويُستخدم تلقائياً عند
              إرسال الرسائل أو استخدام المساعد الذكي حتى نهاية الشهر الحالي.
            </p>
          </div>
        </div>
