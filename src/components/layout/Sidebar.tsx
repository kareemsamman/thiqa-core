      ...
      >
          ...
          <>
            <div className="flex items-center gap-2">
              {isThiqaSuperAdmin ? (
                ...
                <>
                  <img src="https://thiqacrm.b-cdn.net/logonew.png" alt="Thiqa" className="h-9 w-9 rounded-full object-cover" />
        ...
        {collapsed && (
          isThiqaSuperAdmin ? (
            ...
            <img src="https://thiqacrm.b-cdn.net/logonew.png" alt="Thiqa" className="mx-auto h-9 w-9 rounded-full object-cover" />
          )
        )}
      </div>
