...
export function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <NoIndex />
      <main className={`min-h-screen transition-all duration-300 px-2 py-3 pt-[4.5rem] md:pt-6 md:p-6 ${sidebarMargin} ${isThiqaSuperAdmin ? 'pb-6' : 'pb-40 md:pb-32'} ${isImpersonating ? 'mt-10' : ''}`}>
